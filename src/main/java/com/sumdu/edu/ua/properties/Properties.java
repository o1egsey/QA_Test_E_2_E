package com.sumdu.edu.ua.properties;

public final class Properties {
    public static final String ELEPHANT_LOGIN = "oleg.anischenko00+b@gmail.com";
...
//    public static final String GMAIL_PASS = "";
    ...
    // User Web Password
    public static final String WEB_PASSWORD = "12345";
    public static final String WEB_PASSWORD_1 = "12345";
    // Backup Name
    public static final String BACKUP_NAME = "Backup";

    public static final String NEW_PASS = "Qa1512*";
}
