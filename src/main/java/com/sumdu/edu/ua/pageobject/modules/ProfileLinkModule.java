...
public class ProfileLinkModule extends BasePage {
    private WebElement userInformationLabel;

    public ProfileLinkModule(WebDriver webDriver) {
        super(webDriver);
    }

    public String getUserInformationLabel() {
        userInformationLabel = new WebDriverWait(webDriver, 10)
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[text()=\"beasumy+a@gmail.com\"]")));
